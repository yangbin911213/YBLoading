...
- (CAShapeLayer *)progressLayer {
    if (!_progressLayer) {
        ...
        _progressLayer.strokeColor = RGBCOLORV(0xffffff).CGColor;
...
- (CAShapeLayer *)progressLayerBackGround {
    if (!_progressLayerBackGround) {
        ...
        _progressLayerBackGround.strokeColor = RGBCOLORVA(0x222222, 0.5).CGColor;
